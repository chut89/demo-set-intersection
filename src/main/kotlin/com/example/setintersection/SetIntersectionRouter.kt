...
class SetIntersectionRouter {
    @Bean
    @RouterOperations(
      RouterOperation(path = "/api/setintersection/complex", operation = Operation(operationId = "setintersectionPost", summary = "Computes intersection of two sets " +
      "when they are so large that must be put into request body", description = "Returns matching elements of the two sets", tags = [ "Set Intersection complex" ], 
